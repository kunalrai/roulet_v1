...
if exists(select * from sys.objects where type = 'p' and name ='ReceiveTransferredPoints')
begin
drop procedure ReceiveTransferredPoints
end
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE ReceiveTransferredPoints
	-- Add the parameters for the stored procedure here
	  @to_member_id nvarchar(36),
	  @gameid nvarchar(36),
	  @ids nvarchar(max)
